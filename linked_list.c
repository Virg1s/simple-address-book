...
void insert_after(struct linked_list *list, struct list_item *previous, struct list_item *new)
{
	new->prev = previous;
...
void insert_before(struct linked_list *list, struct list_item *subsequent, struct list_item *new)
{
	new->next = subsequent;
