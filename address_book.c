...
int main()
{
	...
	puts("#########################\n");
	name = "paskutinis_kontaktas", surname = "paskutine_pavarde",
	email = "paskutinis_emailas", phone = "paskutinis_telefonas";
	...
	puts("#########################\n");
	position = 2;
	name = "antras_kontaktas", surname = "paskutine_pavarde",
	email = "antras_emailas", phone = "antras_telefonas";
	printf("Adding item: '%s', surname: '%s', email: '%s', phone: '%s' to position %d\n",
	       name, surname, email, phone, position);
	add_contact_to_position(address_book, position, name, surname, email,
				phone);
	printf("Address book contents:\n\n");
	print_list(address_book);
	puts("#########################\n");
